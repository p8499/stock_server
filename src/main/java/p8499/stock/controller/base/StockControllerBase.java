...
import p8499.stock.service.StockService;

public abstract class StockControllerBase {
  protected static final String path = "api/stck";
  protected static final String listPath = "api/stck_list";
  protected static final String attachmentPath = "api/stck_attachment";
  protected static final String pathKey = "/{stid:.+}";
  ...
  public String get(
    ...
    StockMask maskObj =
        mask == null || mask.equals("")
            ? new StockMask().all(true)
            : new StockMask(Long.valueOf(mask));
    Stock bean = onGet(session, request, response, stid, maskObj);
    return jackson.writeValueAsString(bean);
  }

  @Nullable
  protected abstract Stock onGet(
      @Nonnull HttpSession session,
      @Nonnull HttpServletRequest request,
      @Nonnull HttpServletResponse response,
      @Nonnull String stid,
      @Nonnull StockMask mask)
      throws Exception;
  ...
  public String add(
      ...
      throws Exception {
    onAdd(session, request, response, stid, bean);
    return jackson.writeValueAsString(bean);
  }

  @Nullable
  protected abstract Stock onAdd(
      @Nonnull HttpSession session,
      @Nonnull HttpServletRequest request,
      @Nonnull HttpServletResponse response,
      @Nonnull String stid,
  ...
  public String update(
    ...
    StockMask maskObj =
        mask == null || mask.equals("")
            ? new StockMask().all(true)
            : new StockMask(Long.valueOf(mask));
    onUpdate(session, request, response, stid, bean, maskObj);
    return jackson.writeValueAsString(bean);
  }

  @Nullable
  protected abstract Stock onUpdate(
      @Nonnull HttpSession session,
      @Nonnull HttpServletRequest request,
      @Nonnull HttpServletResponse response,
      @Nonnull String stid,
  ...
  public void delete(
      ...
      @PathVariable String stid)
      throws Exception {
    onDelete(session, request, response, stid);
  }
  ...
  @Nonnull
  protected abstract List<Stock> onQuery(
      @Nonnull HttpSession session,
      @Nonnull HttpServletRequest request,
      @Nonnull HttpServletResponse response,
      @Nullable FilterExpr filter,
  ...
  public void downloadAttachment(
      ...
      throws Exception {
    byte[] bytes = onReadAttachment(session, request, response, stid, name);
    if (bytes != null) {
  ...
  public void uploadAttachment(
    ...
    onWriteAttachment(session, request, response, stid, name, bytes);
  }
  ...
  public void deleteAttachment(
      ...
      @RequestParam(required = false) String name)
      throws Exception {
    onDeleteAttachment(session, request, response, stid, name);
  }
  ...
  public String listAttachments(
      ...
      @PathVariable String stid)
      throws Exception {
    List<String> result = onListAttachments(session, request, response, stid);
