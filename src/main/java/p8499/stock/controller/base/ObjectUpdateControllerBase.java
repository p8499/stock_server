...
public abstract class ObjectUpdateControllerBase {
  protected static final String path = "api/obup";
  protected static final String listPath = "api/obup_list";
  protected static final String attachmentPath = "api/obup_attachment";
  protected static final String pathKey = "/{obid:.+}";
  ...
  public String get(
      ...
      @PathVariable Integer obid,
      @RequestParam(required = false) String mask)
      throws Exception {
    ObjectUpdateMask maskObj =
        mask == null || mask.equals("")
            ? new ObjectUpdateMask().all(true)
            : new ObjectUpdateMask(Long.valueOf(mask));
    ObjectUpdate bean = onGet(session, request, response, obid, maskObj);
    return jackson.writeValueAsString(bean);
  }

  @Nullable
  protected abstract ObjectUpdate onGet(
      @Nonnull HttpSession session,
      @Nonnull HttpServletRequest request,
      @Nonnull HttpServletResponse response,
      @Nonnull Integer obid,
      @Nonnull ObjectUpdateMask mask)
      throws Exception;
  ...
  @Nullable
  protected abstract ObjectUpdate onAdd(
      @Nonnull HttpSession session,
      @Nonnull HttpServletRequest request,
      @Nonnull HttpServletResponse response,
      @Nullable ObjectUpdate bean)
      throws Exception;
  ...
  public String update(
    ...
    ObjectUpdateMask maskObj =
        mask == null || mask.equals("")
            ? new ObjectUpdateMask().all(true)
            : new ObjectUpdateMask(Long.valueOf(mask));
    onUpdate(session, request, response, obid, bean, maskObj);
    return jackson.writeValueAsString(bean);
  }

  @Nullable
  protected abstract ObjectUpdate onUpdate(
      @Nonnull HttpSession session,
      @Nonnull HttpServletRequest request,
      @Nonnull HttpServletResponse response,
      @Nonnull Integer obid,
  ...
  public void delete(
      ...
      @PathVariable Integer obid)
      throws Exception {
    onDelete(session, request, response, obid);
  }
  ...
  @Nonnull
  protected abstract List<ObjectUpdate> onQuery(
      @Nonnull HttpSession session,
      @Nonnull HttpServletRequest request,
      @Nonnull HttpServletResponse response,
      @Nullable FilterExpr filter,
  ...
  public void downloadAttachment(
      ...
      throws Exception {
    byte[] bytes = onReadAttachment(session, request, response, obid, name);
    if (bytes != null) {
  ...
  public void uploadAttachment(
    ...
    onWriteAttachment(session, request, response, obid, name, bytes);
  }
  ...
  public void deleteAttachment(
      ...
      @RequestParam(required = false) String name)
      throws Exception {
    onDeleteAttachment(session, request, response, obid, name);
  }
  ...
  public String listAttachments(
      ...
      @PathVariable Integer obid)
      throws Exception {
    List<String> result = onListAttachments(session, request, response, obid);
  ...
  protected ObjectUpdateService objectUpdateService;
}
